...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-CuFlRWUO.js')),
			__memo(() => import('./chunks/1-CkvD00Ef.js')),
			__memo(() => import('./chunks/2-7wHm26_s.js')),
			__memo(() => import('./chunks/3-DviNV2A2.js')),
			__memo(() => import('./chunks/4-BoZlKBEE.js')),
			__memo(() => import('./chunks/5-CB3E11qU.js')),
			__memo(() => import('./chunks/6-CLFn3aQt.js')),
			__memo(() => import('./chunks/7-Br1OzkrK.js')),
			__memo(() => import('./chunks/8-4A6XjTyp.js')),
			__memo(() => import('./chunks/9-BE-fFOrp.js')),
			__memo(() => import('./chunks/10-CRXBh8iH.js')),
			__memo(() => import('./chunks/11-B3vuLebx.js')),
			__memo(() => import('./chunks/12-CLgXsjOz.js')),
			__memo(() => import('./chunks/13-BkJjB6Uv.js')),
			__memo(() => import('./chunks/14-C66axEoi.js')),
			__memo(() => import('./chunks/15-BtQZNV_-.js')),
			__memo(() => import('./chunks/16-Bc8PEldf.js')),
			__memo(() => import('./chunks/17-Dkr-w8BY.js')),
			__memo(() => import('./chunks/18-DF6pYU0e.js')),
			__memo(() => import('./chunks/19-ByWKOxs_.js')),
			__memo(() => import('./chunks/20-3Arb0b1a.js')),
			__memo(() => import('./chunks/21-CuQL9CiI.js')),
			__memo(() => import('./chunks/22-Bzo97kBO.js')),
			__memo(() => import('./chunks/23-Y2IyklmZ.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-B8O8gGfE.js'))
			},
			{
				id: "/api/diary/create",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-C1ESzga7.js'))
			},
			{
				id: "/api/diary/delete",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BbsEWZK8.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DQ1hkPna.js'))
			},
			{
				id: "/api/diary/update",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-B9Fcu1-C.js'))
			},
			{
				id: "/chat/[category]",
				pattern: /^\/chat\/([^/]+?)\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-iNGBCdqU.js'))
			}
		],
