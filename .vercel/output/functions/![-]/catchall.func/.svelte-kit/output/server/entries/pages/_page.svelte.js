...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<main class="staging-look svelte-1uha8ag"><section class="hero-section svelte-1uha8ag" aria-label="Introduktion till MittPsyke"><div class="hero-bg svelte-1uha8ag"></div> <div class="hero-overlay svelte-1uha8ag"></div> <div class="hero-content svelte-1uha8ag"><h1 class="svelte-1uha8ag">Välkommen till MittPsyke</h1> <p class="svelte-1uha8ag">Hitta rätt stöd för psykiskt mående på ett enkelt och tryggt sätt.</p> <a href="/om-mittpsyke" class="hero-cta svelte-1uha8ag">Läs mer om MittPsyke</a></div></section> <section class="focus-section svelte-1uha8ag"><div class="narrow cards-narrow focus-content svelte-1uha8ag"><header class="focus-header svelte-1uha8ag"><h2 class="svelte-1uha8ag">Välj fokusområde</h2> <p class="svelte-1uha8ag">Du behöver inte förklara allt. Välj det som känns närmast just nu.</p></header> <div class="focus-cards svelte-1uha8ag"><!--[-->`);
