import { e as escape_html, h as head, a as attr } from "../../chunks/index.js";
import "clsx";
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<header class="sticky top-0 z-30 border-b border-black/8 bg-white/75 dark:bg-black/35 backdrop-blur"><div class="flex items-center justify-between gap-3 px-5 py-3.5"><div class="flex items-center gap-3 sm:gap-4 min-w-0"><a href="/" class="flex items-center gap-2.5 font-semibold opacity-95 hover:opacity-100 transition-opacity"><img src="/assets/home/MittpsykeTree.jpg" alt="MittpsykeTree" class="h-9 w-auto rounded-md"/></a> <nav class="hidden md:flex items-center gap-4"><a href="/om-mittpsyke" class="text-sm opacity-80 hover:opacity-100 hover:underline transition-opacity">Om MittPsyke</a> <a href="https://stodlinjer.se" target="_blank" rel="noopener noreferrer" class="text-sm opacity-80 hover:opacity-100 hover:underline transition-opacity">Akut hjälp (Stödlinjer)</a></nav></div> <div class="flex items-center gap-3"><nav class="hidden md:flex items-center gap-4">`);
      {
        $$renderer2.push("<!--[!-->");
