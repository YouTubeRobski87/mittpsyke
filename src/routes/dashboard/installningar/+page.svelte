...
\tlet deleteMessageType = <'success' | 'error'>('success');
	...
	async function deleteAccount() {
		deleteMessage = ''radera''Skriv RADERA i f�ltet f�r att bekr�fta.''error''/login''/api/account/delete''DELETE''Kunde inte n� servern. F�rs�k igen.''error''error''string''Kunde inte radera kontot.''error''Ditt konto har raderats. Du loggas ut...''success'';
