	...
	<section class="container max-w-2xl py-12">
		<div class="flex flex-wrap items-center justify-between gap-3 mb-3">
			...
			<button
				...
				class="px-4 py-2 rounded-[var(--radius-input)] border border-black/12 dark:border-white/12 bg-[var(--bg-card)] text-sm opacity-85 hover:opacity-100 disabled:opacity-45 transition-opacity"
			>
		...
		<div class="rounded-[var(--radius-card)] border border-black/10 dark:border-white/8 bg-[var(--bg-card)] p-4 mb-7">
			...
			<div class="mt-3 flex justify-end">
				<button
					...
					class="px-5 py-2.5 rounded-[var(--radius-input)] border border-black/12 dark:border-white/12 bg-[var(--bg-card)] text-sm font-medium opacity-90 hover:opacity-100 disabled:opacity-45 transition-opacity"
				>
					{saving ? 'Sparar...' : 'Spara'}
				</button>
			</div>
		...
		<div class="mb-7 rounded-[var(--radius-card)] border border-black/10 dark:border-white/8 bg-[var(--bg-card)] p-4">
			...
			{#if !statsError}
				<div class="mb-3 rounded-[var(--radius-input)] border border-black/8 dark:border-white/8 bg-[var(--bg-card)] p-3">
							...
							<div class="mb-2 flex items-start justify-between gap-3">
								...
								<div class="flex items-center gap-2">
									<button
										...
										class="text-xs px-2.5 py-1 rounded-[var(--radius-input)] border border-black/12 dark:border-white/12 bg-[var(--bg-card)] opacity-85 hover:opacity-100 disabled:opacity-45 transition-opacity"
									>
										Redigera
									</button>
									<button
		...
		<div class="mt-6 rounded-[var(--radius-input)] border border-black/10 dark:border-white/8 bg-[var(--bg-card)] p-3">
