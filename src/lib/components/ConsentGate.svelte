...
<div class="consent-gate rounded-[var(--radius-card)] border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.04] p-4">
	...
	<div class="mt-3 flex flex-wrap gap-2">
		<button
			type="button"
			class="rounded-[var(--radius-input)] border border-black/12 dark:border-white/12 px-3 py-2 text-sm opacity-85 hover:opacity-100 transition-opacity"
		...
		<button
			type="button"
			class="rounded-[var(--radius-input)] bg-[var(--primary)] px-3 py-2 text-sm font-medium text-white hover:opacity-95 transition-opacity"
