...
<main class="legal-page">
	...
	<section>
		...
		<p>Storify drivs av Johanna Fagerås. Om du har frågor om hur vi hanterar dina uppgifter kan du kontakta oss på <a href="mailto:support@mittpsyke.se">support@mittpsyke.se</a>.</p>
	</section>
	...
	<section>
		...
		<p>Om vi gör väsentliga ändringar i hur vi hanterar dina uppgifter kommer vi att uppdatera denna policy och ändra datumet högst upp. Vi rekommenderar att du tittar in här då och då.</p>
	</section>

	<section>
		<h2>Kontakt</h2>
		<p>Har du frågor eller funderingar om din integritet? Kontakta oss på <a href="mailto:support@mittpsyke.se">support@mittpsyke.se</a>.</p>
	</section>
